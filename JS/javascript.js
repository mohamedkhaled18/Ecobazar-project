...
function addDataToHTML() {
    ...
    let Products = currentPage === "index.html" ? Object.values(products).slice(0, 8) : products;
...
function updateCartHTML() {
    ...
    if (Object.keys(JSON.parse(localStorage.getItem("listCart"))).length == 0)
        itemsContainer.innerHTML = "<p class='empty-ptr'>Cart is empty</p>"
    else {
