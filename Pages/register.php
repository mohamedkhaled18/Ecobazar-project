<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $values = [
      $_POST['firstName'], $_POST['lastName'], $_POST['username'], $_POST['email'], password_hash($_POST['password'], PASSWORD_DEFAULT), $_POST['role']
    ];
    try {
...
<html lang="en">
  <head>
    ...
    <title>Ecobazar | Registation</title>
  ...
  <body id="">
    ...
    <div class="container">
      <form action="" method='post' id="registeration_form">
        <h2>Register</h2>
        <p class="invalid blank-error">Inputs Can Not Be Blank</p>
        <div class="input-data">
          <div class="first-name-input">
            <input type="text" placeholder="First name" name="firstName" id="first-name">
            <p class="invalid invalid-first-name">Invalid first name</p>
          </div>
          <div class="last-name-input">
            <input type="text" placeholder="Last name" name="lastName" id="last-name">
            <p class="invalid invalid-last-name">Invalid last name</p>
          </div>
          <div class="username-input">
            <input type="text" placeholder="Username" name="username" id="username">
            <p class="invalid invalid-username">Username is invalid</p>
          </div>
          ...
          <div class="password-input confirm-pass-input">
            ...
            <p class="invalid mismatch-password">Mismatched Password</p>
          </div>
          ...
          <div class="aggrement">
            ...
            <label for="confirm">Accept all terms & Conditions</label>
          </div>
          <p class="invalid conditions-error">Accept the terms and conditions</p>
        </div>
        <?php if(isset($errorCode) and $errorCode == 1062) :?>
          <p id="duplicate-error" class='error'>
            Your username or email already exists
          </p>
        <?php endif ?>
        <button class="" type="submit">Register</button>
        <p class="gray text-center">Already have account?<a class="" href="./login.php"> Login</a></p>
      </form>

      <div class="register-image">
        <img src="../materials/undraw_sign-in_uva0 (1).png" alt="Registeration">
      </div>
    </div>
